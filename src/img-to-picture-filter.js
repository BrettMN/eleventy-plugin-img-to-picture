...
const defaultSizes = [
  ...
  { screen: { min: 640 }, img: { width: 620 } },
  { screen: { min: 768 }, img: { width: 750 } },
  { screen: { min: 1024 }, img: { width: 1000 } },
...
const formatNewFileName = function (imagePath, size) {
  ...
  const finalImagePath = `${imagePathStart}${sizesText}${
    imagePathChunks[imagePathChunks.length - 1]
  }`;
